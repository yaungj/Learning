 ...
 * 附:集线器、交换机、路由器、网桥、网关之间的区别[1](http://www.cnblogs.com/imapla/archive/2013/03/12/2955931.html)[2](https://blog.csdn.net/gongda2014306/article/details/52442981)
     ...
     * 网桥(Bridge)：工作在数据链路层，将两个LAN连起来，根据MAC地址来转发帧，可以看做低层的路由器
     * 网关（Gateway）：又称网间连接器、协议转换器，是互连网络中操作在OSI网络层之上的具有协议转换功能设施，由于历史的原因，许多有关TCP/IP的文献曾经把网络层使用的路由器称为网关，在今天很多局域网采用都是路由来接入网络，因此通常指的网关就是路由器的IP。如果网络A中的主机发现数据包的目的主机不在本地网络中，就把数据包转发给它自己的网关，再由网关转发给网络B的网关，网络B的网关再转发给网络B的某个主机
